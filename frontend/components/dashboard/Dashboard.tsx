...
import { useGetProjectDetails } from "@/hooks/project/useGetProjectDetails";
import { ProjectListItem } from "@/store/slices/project/projectListSlice";
import { Project, Members, Tasks, setSelectedProject } from "@/store/slices/project/projectSlice";
...
export function Dashboard() {
  ...
  const handleViewProject = async (projectId: string) => {
    try {
      ...
      // Fetch full project details including members and tasks
      ...
      {selectedProject && (
        <ProjectModal
          ...
          onMemberAdd={(email) => {
            ...
            // Implement API call to add member
          }}
        />
      )}
    </div>
        ...
        <form onSubmit={handleSubmit}>
          <div>
            ...
            <input
              ...
              placeholder="Enter project code (e.g., PRO123)"
              required
              autoFocus
            />
